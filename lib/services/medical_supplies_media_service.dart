...
class MedicalSuppliesMediaService {
  final _supabase = Supabase.instance.client;

  // ملاحظة: يجب إنشاء bucket بنفس الاسم في Supabase Storage.
  static const String bucket = 'medical-supplies-images';
  ...
  Future<String> uploadImage(XFile file, String folder) async {
    try {
      ...
      // على الويب file.path قد لا يحتوي امتداداً صحيحاً، لذلك نستخدم الاسم إن وجد
